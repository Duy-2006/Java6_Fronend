...
export default function AuthorBooksList({ books = [], authorName, baseUrl }: AuthorBooksListProps) {
      ...
      {processedBooks.length > 0 ? (
        ...
        <div className="bg-slate-50 border-2 border-dashed border-slate-200 rounded-2xl p-16 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-slate-400 text-sm max-w-sm mt-1">
            Không tìm thấy tựa sách nào của tác giả này khớp với từ khóa tìm kiếm hoặc điều kiện lọc hiện tại.
          </p>
          <button 
