      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-[#e6bdb8]/30 hover:border-[#b70011]/50 transition-all group">
          ...
          <div>
            ...
            <p className="text-[#916f6b] text-[11px] mt-2">Tổng số chương trình đã tạo</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-[#e6bdb8]/30 hover:border-[#b70011]/50 transition-all group">
          ...
          <div>
            ...
            <p className="text-[#916f6b] text-[11px] mt-2">Tính trên các chiến dịch</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-[#e6bdb8]/30 hover:border-[#b70011]/50 transition-all group">
          ...
          <div>
            ...
            <p className="text-[#916f6b] text-[11px] mt-2">Đang áp dụng giảm giá trực tiếp</p>
          </div>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-[#e6bdb8]/10">
              {filteredPromotions.map((p) => {
                ...
                return (
                  <tr key={p.id} className="hover:bg-[#b70011]/5 transition-colors group">
